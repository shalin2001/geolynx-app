...
public class MainFragment extends PreferenceFragmentCompat implements OnSharedPreferenceChangeListener {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        findPreference(KEY_POLICY).setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://geolynx.com.ar/privacidad.html"));
    ...
    private void startTrackingService(boolean checkPermission, boolean permission) {
        ...
        if (permission) {
            ((TwoStatePreference)findPreference(KEY_STATUS)).setChecked(true);
